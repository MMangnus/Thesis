...
\documentclass[openright,12pt,fleqn]{book} % use twoside in options for publishable version
...
\usepackage[
	letterpaper,
	inner=30mm, % publishable: 30mm
	outer=30mm, % publishable: 25mm
	bottom=21.5mm,
	footskip=13.5mm	
...
\newcommand\abstractfont{\setstretch{1.4} \fontsize{11pt}{10pt} \selectfont} % specific font for abstract
...
\usepackage[colorlinks=true,linkcolor=black,citecolor=darkgray,urlcolor=blue]{hyperref} % For hyperlinks in the PDF
\urlstyle{rm}
...
%\afterpage{\blankpage}
\include{./Chapters/06_Appendix/Appendix}
%\afterpage{\blankpage}
